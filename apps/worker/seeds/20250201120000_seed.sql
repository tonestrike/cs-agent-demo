...
VALUES
  ('cache_cust_001', '+15551234567', 'cust_001', 'Alex Rivera', '742 Evergreen Terrace'),
  ('cache_cust_002', '+15559876543', 'cust_002', 'Morgan Lee', '123 Harbor Drive');

INSERT INTO call_sessions (id, started_at, ended_at, phone_e164, customer_cache_id, status, transport, summary)
VALUES
  ('call_001', '2025-02-01T15:00:00Z', '2025-02-01T15:04:00Z', '+15551234567', 'cache_cust_001', 'completed', 'web', 'Appointment inquiry handled.'),
  ('call_002', '2025-02-03T19:30:00Z', NULL, '+15559876543', 'cache_cust_002', 'active', 'web', NULL);
...
VALUES
  ('ticket_seed_001', '2025-02-02T12:00:00Z', '2025-02-02T12:00:00Z', 'open', 'normal', 'billing', 'cache_cust_001', '+15551234567', 'Billing question', 'Customer asked about balance.', NULL, 'agent');
