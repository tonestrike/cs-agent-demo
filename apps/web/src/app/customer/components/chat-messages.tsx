            ...
            <div className="w-full max-w-md rounded-2xl border border-ink-200 bg-white p-6 shadow-soft">
              ...
              <ul className="mt-4 space-y-3">
                <li className="flex items-start gap-3 rounded-lg bg-sand-100 p-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ink">Schedule an appointment</p>
                    <p className="text-xs text-ink-400">"I need to book a pest inspection"</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 rounded-lg bg-sand-100 p-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ink">Reschedule or cancel</p>
                    <p className="text-xs text-ink-400">"I need to move my appointment"</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 rounded-lg bg-sand-100 p-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-ink">Ask a question</p>
                    <p className="text-xs text-ink-400">"What services do you offer?"</p>
                  </div>
                </li>
              </ul>
            </div>
